  ...
  return (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
        <div>
          <h3 className="text-lg font-medium leading-6 text-gray-900">Historial de Asistencias</h3>
      ...
      <div className="border-t border-gray-200">
        {loading ? (
          ...
          <div className="p-4 text-center text-gray-500">No hay registros para esta fecha</div>
        ) : (
              ...
              {registros.map((registro) => (
                <tr key={registro.id}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{formatFecha(registro.hora)}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">
                      {registro.alumnos ? `${registro.alumnos.apellidos}, ${registro.alumnos.nombre}` : 'Desconocido'}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
