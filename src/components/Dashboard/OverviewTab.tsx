  ...
  const tarjetasEstadisticas = [
    ...
    },
    {
      ...
      trend: {
        ...
        isUp: estadisticas.porcentajeAsistencia >= 80,
      },
    ...
    },
    {
      ...
      trend: {
        value:
          Math.round(
            (estadisticas.ausentesHoy / estadisticas.totalAlumnos) * 100
          ) || 0,
        isUp: false,
      },
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span
                      className={`text-sm ${
                        tarjeta.trend.isUp ? "text-green-600" : "text-red-600"
                      }`}
                    >
                      {tarjeta.trend.value}%
                    </span>
                ...
                <div
                  className={`w-12 h-12 ${colores.icon} rounded-full flex items-center justify-center`}
                >
...
function EstadisticasPorGrado({
  ...
  const grados = Object.keys(estadisticasPorGrado).sort(
